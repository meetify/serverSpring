...
/**
 * Google place representation. It can be taken using [PlaceService.details].
...
@JsonIgnoreProperties(ignoreUnknown = true) data class GooglePlaceDetailed(
     ...
     */
    @JsonIgnoreProperties(ignoreUnknown = true) data class AddressComponent(
            @JsonProperty("long_name") val longName: String = "",
            @JsonProperty("short_name") val shortName: String = "",
            val types: List<String> = ArrayList()) : Serializable
     ...
     */
    @JsonIgnoreProperties(ignoreUnknown = true) data class AlternativeId(
     ...
     */
    @JsonIgnoreProperties(ignoreUnknown = true) data class Aspect(
            val rating: Int = 0,
     ...
     */
    @JsonIgnoreProperties(ignoreUnknown = true) data class DayTime(
            val day: Int = 0,
     ...
     */
    @JsonIgnoreProperties(ignoreUnknown = true) data class Geometry(
     ...
     */
    @JsonIgnoreProperties(ignoreUnknown = true) data class OpeningHours(
     ...
     */
    @JsonIgnoreProperties(ignoreUnknown = true) data class GoogleLocation(
            val lat: Double = 0.0,
     ...
     */
    @JsonIgnoreProperties(ignoreUnknown = true) data class Period(
     ...
     */
    @JsonIgnoreProperties(ignoreUnknown = true) data class Photo(
     ...
     */
    @JsonIgnoreProperties(ignoreUnknown = true) data class Result(
            ...
            @JsonProperty("alt_ids") val alternativeIds: List<AlternativeId> = ArrayList(),
            @JsonProperty("address_components") val addressComponents: List<AddressComponent> = ArrayList(),
            val reviews: List<Review> = ArrayList()) : Serializable
     ...
     */
    @JsonIgnoreProperties(ignoreUnknown = true) data class Review(
            val aspects: List<Aspect> = ArrayList(),
     ...
     */
    @JsonIgnoreProperties(ignoreUnknown = true) data class Viewport(
